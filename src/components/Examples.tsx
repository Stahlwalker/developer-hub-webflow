    ...
    <section id="examples" className="py-20 px-4 sm:px-6 lg:px-8 bg-crt-dark/30">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-5xl font-bold font-mono mb-4 text-terminal-green neon-text">$ CODE_EXAMPLES</h2>
          ...
          {examples.map((example, index) => (
            <div key={index} className="retro-card p-6">
              <div className="flex items-center gap-4 mb-4">
                <span className="text-terminal-cyan font-mono text-2xl font-bold">0{index + 1}</span>
                <div>
                  <h3 className="text-xl font-semibold font-mono text-terminal-cyan">{example.title}</h3>
