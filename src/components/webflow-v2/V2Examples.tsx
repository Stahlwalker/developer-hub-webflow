...
const examples: CodeExample[] = [
  {
    ...
    description: 'Retrieve every site in your Webflow workspace with a single authenticated request.',
    method: 'GET',
    endpoint: '/v2/sites',
    highlights: [
...
console.log(data.sites);`,
  ...
  },
  {
    ...
    description: 'Programmatically add structured content to any CMS collection.',
    method: 'POST',
...
console.log(data);`,
  ...
  {
    title: 'Publish Site',
    description: 'Deploy your site to production on any connected custom domain.',
    method: 'POST',
    endpoint: '/v2/sites/{site_id}/publish',
    highlights: [
      'Publish to one or all domains',
